...
public class BrevoConfig {
    ...
    public RestClient BrevoRestClient(BrevoProperties properties) {
        return RestClient.builder().baseUrl(BREVO_BASE_URL).defaultHeader("api-key", properties.apiKey).defaultHeader("Content-Type", "application/json").defaultHeader("Accept", "application/json").build();
    }
